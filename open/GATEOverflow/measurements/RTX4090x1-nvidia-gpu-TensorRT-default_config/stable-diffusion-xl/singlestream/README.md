...
### Accuracy Results 
`CLIP_SCORE`: `31.26895`, Required accuracy for closed division `>= 31.68632` and `<= 31.81332`
`FID_SCORE`: `23.27731`, Required accuracy for closed division `>= 23.01086` and `<= 23.95008`

### Performance Results 
`90th percentile latency (ns)`: `1419926072.0`
